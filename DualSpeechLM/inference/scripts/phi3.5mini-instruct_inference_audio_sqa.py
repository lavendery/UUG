...
if __name__ == "__main__":
    ...
    f_out = open(args.asr_gen_file, 'w')
    f_gt = open(args.asr_gt_file, 'w')
    cnt = 0
    for dataset_path in all_dataset_path:
        ...
        for sample in dataset:
            try:
                ...
                question = "Based on the content, provide a text-based answer to the question. "

                input_tokens = tokenizer.bos_token + question + s_token + " The content is: " + audio_tokens + sep + "The question is: " + text_question + sep + e_token + ' '
