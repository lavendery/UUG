...
if __name__ == "__main__":
    ...
    os.makedirs(os.path.dirname(args.asr_gen_file), exist_ok=True)
    ...
    for dataset_path in all_dataset_path:
        ...
        for sample in dataset:
            try:
                ...
                question = "Please translate the " + data['metadata']['source_language'] + " speech into " + data['metadata']['target_language'] + " text transcription. "
